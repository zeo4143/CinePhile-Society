...
export default function Movie(){
    ...
    const url = `https://imdb-api.com/en/API/Title/k_edf5o5xd/${movieId}`
    const url1 = `https://imdb-api.com/en/API/Trailer/k_edf5o5xd/${movieId}`
    ...
    return(
<div>
    <div className='coverImg'> <img  src={trailer?.thumbnailUrl} alt='cover' className='coverMainImg'/>
    </div>
